        ...
        <div class="u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-list u-list-1">
            ...
            <div class="u-container-style u-list-item u-repeater-item u-white u-list-item-1">
                <div class="u-container-layout u-similar-container u-valign-bottom u-container-layout-1">
                    ...
                    echo '</h5>
                                <input name="flower_id" value="'; echo $row["flower_id"]; echo '" visibility: hidden>
                    ...
                    echo '</select>
                    <a id="submit3" '; if (!isset($_SESSION['user_id'])) {
                        echo 'onclick="location.href=\'https://localhost/flowbase/pages/login.php\'"';
                    } else {
                        echo 'onclick="addFav(this)"';
                    }
                    echo ' class="u-btn u-button-style u-hover-palette-1-dark-1 u-palette-1-base u-btn-1">добавить</a>
                </div>
            </div>
            </div>
        </div>
